        ...
        with gr.TabItem(i18n("1-GPT-SoVITS-TTS")):
            ...
            with gr.TabItem(i18n("1B-微调训练")):
                ...
                with gr.Row():
                    with gr.Column():
                        with gr.Row():
                            ...
                            total_epoch = gr.Slider(minimum=1,maximum=50,step=1,label=i18n("总训练轮数total_epoch，不建议太高"),value=8,interactive=True)
                        with gr.Row():
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        with gr.Column():
                                if_save_latest1Bb = gr.Checkbox(label=i18n("是否仅保存最新的ckpt文件以节省硬盘空间"), value=False, interactive=True, show_label=True)
